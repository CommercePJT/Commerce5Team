...
VALUES ('테스트관리자', 'admin@test.com', 'encoded_pw', '010-1111-1111', 'CS_ADMIN', 'ACTIVE', NOW(), NOW());
...
INSERT INTO products (product_name, category, price, stock, status, admin_id, created_at, modified_at)
