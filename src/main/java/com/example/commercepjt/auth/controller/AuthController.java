...
public class AuthController {
    ...
    public ResponseEntity<Void> login(
        ...
        // 필요한 정보 세션에 저장
        session.setAttribute(SessionConst.Admin_ID, loginAdmin.getId());
        session.setAttribute(SessionConst.Admin_EMAIL, loginAdmin.getEmail());
        session.setAttribute(SessionConst.Admin_ROLE, loginAdmin.getRole());
